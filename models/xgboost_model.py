...
COLUMN_MAP = {
    ...
    # ByteTrack columns pass through unchanged (no remapping needed)
}
...
def build_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    defaults = {
        ...
        "occupancy":        0.0,
        "sensor_flow":      0.0,
        # ByteTrack defaults — filled with 0 if columns absent (e.g. older datasets)
        "flow_rate_veh_hr": 0.0,
        "active_tracks":    0.0,
    }
...
FEATURE_COLS = [
    ...
    # ByteTrack features
    "flow_rate_veh_hr", "active_tracks",
    # Weather
